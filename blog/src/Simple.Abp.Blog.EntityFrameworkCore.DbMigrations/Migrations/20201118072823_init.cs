...
namespace Simple.Abp.Blog.Migrations
{
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AbpCatalogs", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SEOPath = table.Column<string>(maxLength: 200, nullable: true),
                    ...
                    IsRefinement = table.Column<bool>(nullable: false, defaultValue: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AbpArticles_AbpCatalogs_CatalogId",
                        column: x => x.CatalogId,
                        principalTable: "AbpCatalogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
